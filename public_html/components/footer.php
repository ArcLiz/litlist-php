<!-- Footer -->
<div class="bg-neutral-700 mt-auto border-t border-neutral-600">
    <footer class="mx-auto container">
        <div
            class="divide-y divide-neutral-700">
            <div class="text-neutral-300 text-xs uppercase text-right py-2 pr-1 md:hidden">
                <a href="">upp <i class="fa-solid fa-arrow-up"></i></a>
            </div>
...
<script src="https://kit.fontawesome.com/9289bd467b.js" crossorigin="anonymous"></script>
</body>
